    ...
    volumes = [
      ...
      "${pkgs.writeText "servers.json" ''
        ...
        "${pkgs.writeText "ping.json" ''
        {
          ...
          "motd": "               <bold><gradient:#ff0080:light_purple>Cherry Cave</gradient></bold><reset> <gray>♦ <white>[26.2]<newline>           <gray>Made with <light_purple>❤</light_purple> in <gradient:#8052fe:#e1416a>Kotlin</gradient> and <#D34516>Rust",
