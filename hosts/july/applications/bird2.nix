...
let script = pkgs.writeShellScriptBin "update-roa" ''
    ...
    ${pkgs.curl}/bin/curl -sfSLR {-o,-z}/etc/roa_dn42.conf https://dn42.burble.com/roa/dn42_roa_bird2_4.conf
...
in
{
  services.bird2 = {
    ...
    config = ''
      ...
      define OWNNETSET = [172.23.181.160/27+];
      define OWNNETSETv6 = [fd42:e99e:1f58::/48+];
